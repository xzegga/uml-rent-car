...
import ListTable from '../../components/Garages/ListTable';
import Navigation from '../../components/Navigation';
import NavLnk from '../../components/NavLnk';
import { useAuth } from '../../context/AuthContext';
import { deleteGarage as deleteItem } from '../../data/Garage';
import { useStore } from '../../hooks/useGlobalStore';
import { NavLink } from 'react-router-dom';
import { RepeatIcon } from '@chakra-ui/icons';

const getFunction = 'getGarages';
    ...
    const getQuery = async () => {
        try {
            if (currentUser) {
                ...
                setState({
                    loading: false, loadingMore: false, garages: [
                        ...results?.data?.items || []
                    ]
                });
            }
                        ...
                        <Box pt={10}>
                            <Box>
                                <Flex justifyContent={'flex-end'} alignItems={'center'}>
                                    ...
                                    <Box ml={3}>
                                        <NavLnk to="add" name="Garage Nuevo" colorScheme="blue.500" bg="blue.700" size="md" color="white">
                                            Garage Nuevo
                                        </NavLnk>
                                    </Box>
                                </Flex>
